    ...
    : wxScrolledWindow(parent, id)
{
    ...
    _chatLogic = std::make_unique<ChatLogic>(); // Make the _chatLogic pointer a unique smart pointer.
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    //delete _chatLogic;    // Now its no longer neccessary to do the deallocation.
                            // Because its a smart pointer.
